  ...
  return (
    <div className="">
      <label className="font-semibold text-xs text-gray-600">
        ...
        <div className="relative mt-1">
          <Field
            className="p-2.5 w-full rounded outline-none text-sm bg-gray-50 border border-gray-200 focus:border-[#007bff] "
            // id={name}
            // name={name}
            {...props}
            required
  ...
  return (
    <div className="">
      <label className="font-semibold text-xs text-gray-600">
        ...
        <div className="relative mt-1">
          <Field
            className="p-2.5 w-full outline-none bg-gray-50 border border-gray-200 focus:border-[#007bff] rounded"
            // id={name}
            // name={name}
            {...props}
